{
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 192.5, 523.72882604599, 42.0, 22.0 ],
                    "text": "out~ 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 453.05881452560425, 447.0588150024414, 59.0, 22.0 ],
                    "text": "mute 1, 0"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 709.5588099956512, 385.71426272392273, 58.0, 22.0 ],
                    "text": "r mute.all"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 621.0083663463593, 485.0, 56.0, 22.0 ],
                    "text": "thispoly~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 621.0083663463593, 385.71426272392273, 59.0, 22.0 ],
                    "text": "mute 0, 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 192.0, 49.0, 28.0, 22.0 ],
                    "text": "in 1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 672.3077564239502, 598.4615955352783, 244.0, 75.0 ],
                    "viewvisibility": 1
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 224.0, 50.0, 138.65545392036438, 20.0 ],
                    "text": "<in> in let for poly",
                    "textcolor": [ 0.870588, 0.415686, 0.062745, 1.0 ]
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 377.9411692619324, 409.0, 94.11764526367188, 22.0 ],
                    "text": "line~"
                }
            },
            {
            ...
            {
                "box": {
                    "addpoints": [ 0.0, 0.0, 0, 56.829842217761495, 0.5039403213399585, 0, 97.55838160996748, 0.26204864201955796, 0, 241.52803214118154, 0.2553294460703388, 0, 356.1354513140562, 0.0, 0 ],
                    "classic_curve": 1,
        ...
        "lines": [
            ...
            {
                "patchline": {
                    "color": [ 0.0, 0.8880677819252014, 0.0, 1.0 ],
            ...
            {
                "patchline": {
                    "color": [ 0.8726214170455933, 0.20780962705612183, 0.19446265697479248, 1.0 ],
                    "destination": [ "obj-41", 0 ],
                    "source": [ "obj-50", 0 ]
                }
            }
